...
# shellcheck disable=SC2034
if [[ -z "${POSTGRES_11_DROP_SYNC_TABLES:-}" ]]; then declare -r POSTGRES_11_DROP_SYNC_TABLES="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_10_dropSyncTables.sql"; fi
...
if [[ -z "${POSTGRES_13_DROP_BASE_TABLES:-}" ]]; then declare -r POSTGRES_13_DROP_BASE_TABLES="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_12_dropBaseTables.sql"; fi
...
if [[ -z "${POSTGRES_21_CREATE_ENUMS:-}" ]]; then declare -r POSTGRES_21_CREATE_ENUMS="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_20_createBaseTables_enum.sql"; fi
if [[ -z "${POSTGRES_22_CREATE_BASE_TABLES:-}" ]]; then declare -r POSTGRES_22_CREATE_BASE_TABLES="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_21_createBaseTables_tables.sql"; fi
if [[ -z "${POSTGRES_23_CREATE_CONSTRAINTS:-}" ]]; then declare -r POSTGRES_23_CREATE_CONSTRAINTS="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_22_createBaseTables_constraints.sql"; fi
if [[ -z "${POSTGRES_24_CREATE_SYNC_TABLES:-}" ]]; then declare -r POSTGRES_24_CREATE_SYNC_TABLES="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_23_createSyncTables.sql"; fi
if [[ -z "${POSTGRES_25_CREATE_PARTITIONS:-}" ]]; then declare -r POSTGRES_25_CREATE_PARTITIONS="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_24_createPartitions.sql"; fi
...
if [[ -z "${POSTGRES_41_LOAD_PARTITIONED_SYNC_NOTES:-}" ]]; then declare -r POSTGRES_41_LOAD_PARTITIONED_SYNC_NOTES="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_30_loadPartitionedSyncNotes.sql"; fi
if [[ -z "${POSTGRES_42_CONSOLIDATE_PARTITIONS:-}" ]]; then declare -r POSTGRES_42_CONSOLIDATE_PARTITIONS="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_31_consolidatePartitions.sql"; fi
if [[ -z "${POSTGRES_43_MOVE_SYNC_TO_MAIN:-}" ]]; then declare -r POSTGRES_43_MOVE_SYNC_TO_MAIN="${SCRIPT_BASE_DIRECTORY}/sql/process/processPlanetNotes_33_moveSyncToMain.sql"; fi
